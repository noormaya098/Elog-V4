...
const App = ({match}) => (
  <div className="gx-main-content-wrapper">
    <Switch>
      ...
      <Route path={`${match.url}masterdata/detailsp/:idmp`} component={asyncComponent(() => import('./MasterData/DetailSP/Index'))}/>
      <Route path={`${match.url}masterdata/splist`} component={asyncComponent(() => import('./MasterData/SP List/index'))}/>
