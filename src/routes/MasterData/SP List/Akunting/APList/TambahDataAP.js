...
function TambahDataAP() {
  ...
  // ap/get-data-sm?idSm=207387 

  // const handleAddd = (id) => async () => {
  //   try {
  //     const respons = await axios.get(
  //       `${Baseurl}ap/get-data-sm?idSm=${id}`,
  //       {
  //         headers: {
  //           "Content-Type": "application/json",
  //           Authorization: localStorage.getItem("token"),
    ...
    <div>
      <Card>
        ...
        <Row>
          ...
          <Col sm={5} style={{ marginLeft: "-5px" }}>
            {/* <Button onClick={() => tombolEdit () } style={{ backgroundColor: "orange", color: "white" }}>
        ...
        >
          ...
          <Col sm={2} style={{ marginLeft: "20px" }}>
            <Form.Item label="No Inv Mitra :: " labelCol={{ span: 24 }} style={{fontWeight: "bold"}}>
              <Input.Group compact style={{ marginLeft: "10px" }}>
              <Select
          ...
          <Col sm={2} style={{ marginLeft: "20px" }}>
            ...
            >
              <Input.Group compact style={{ marginLeft: "10px" }}>
                ...
                <Button style={{ width: "30%" }} type="danger"  onClick={(e)=>{handleAdd(e)
                  console.log(e)}
                  }>
              Add
            </Button>
